    ...
    <div id="home-box">
        ...
        <article class="home-article">
            ...
            <p style="color: white;">
                ...
                translates theory into practice, and ideas into action and creates an opportunity for purposeful civic
                learning through a lived experience of the Jesuit mission – solidarity with those in need (preferential
                        ...
                        <div class="col-md-3" class="cardClass">
                            <a href="{{ route('articles.Details', $item->id) }}"
                                ...
                                <div class="card h-100" style="margin-top: 50px !important;" id="card">
                                    ...
                                    <p style="padding:5px; font-size:12px" id="publish-date">
                                        {{ date('F j, Y', strtotime($item->published_date)) }}</p>
                                </div>
                            </a>
                        </div>
                    @endforeach
