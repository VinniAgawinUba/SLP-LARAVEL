    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.departmentsUpdate', $department->id) }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="college_id" required class="form-control select2">
                                    ...
                                    @foreach($colleges as $college)
                                        <option value="{{ $college->id }}" {{ $college->id == $department->college_id ? 'selected' : '' }}>
                                            {{ $college->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-12 mb-3">
                                <button type="submit" name="departmentUpdate" class="btn btn-primary">Update Department</button>
                            </div>
                        </div>
                    </form>
                </div>
