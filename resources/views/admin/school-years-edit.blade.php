...
<div class="container-fluid px-4">
    <h4 class="mt-4">Edit School Year</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.schoolYearsUpdate', $schoolYear->id) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="">School Year</label>
                                <input type="text" name="school_year" value="{{ $schoolYear->school_year }}" required class="form-control">
                            </div>
                            <div class="col-md-12 mb-3">
