...
<div class="container-fluid" id="first-content">
                ...
                @if ($schoolYears->isNotEmpty())
                    @foreach ($schoolYears as $item)
                        <div class="col-md-3 mb-6 gy-3" style="display: flex; justify-content: center; flex-wrap: wrap">
                            <a href="{{ route('projects.show_semester', ['school_year_id' => $item->id]) }}">
                                <div class="year" id="school_year_{{ $item->id }}"
                                    style="text-align: center; justify-content: center;">
                                    <div class="card-body">
                                        <!-- <h5 class="card-title text-white text-center"></h5> -->

                                        <p class="card-text text-center" id="year-font-style"><span
                                                id="sy">SY</span><br>{{ $item->school_year }}</p>
                                    </div>
                                </div>
                            </a>
                        </div>
    ...
    {{ $schoolYears->links('pagination::bootstrap-5') }}
</div>
